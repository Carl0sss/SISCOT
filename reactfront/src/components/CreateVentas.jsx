...
const CreateVentas = () => {
    ...
    const handleAgregarDetalle = (event) => {
        ...
        const subtotal =
            detalleData.PRECIO_UNITARIO * detalleData.CANTIDAD_PRODUCTO;
        ...
        setVentaData({
            ...
            TOTAL_VENTA:
                ventaData.SUBTOTAL_VENTA +
                (ventaData.SUBTOTAL_VENTA + subtotal) * 0.13 +
                subtotal,
        });
                        ...
                        <div className='mb-3 row'>
                            ...
                            <div className='col-8'>
                                <input
                                    ...
                                    className='form-control'
                                />
                                <small className='text-muted'>Dirección cliente</small>
                            </div>
                        </div>
                        <div className='mb-3 row'>
                            <div className='col-8'>
