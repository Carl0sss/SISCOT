...
class VentasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $lastId = Venta::orderBy('FECHA_VENTA', 'desc')->first()->ID_VENTA;
        ...
        if ($detalles) {
            foreach ($detalles as $detalle) {
                ...
                $detalleVenta->CANTIDA_PRODUCTO = $detalle['CANTIDAD_PRODUCTO'];
        ...
        return response()->json(['message' => 'Cotización creada exitosamente' . $lastId]);
